...
<div id="content" class="main-content">
        ...
        <body>
            <h1 style="color: black;" class="text-center mb-4">Tambah Link</h1>
                            ...
                            <div class="card-body">
                                <form action="/submitdata2" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control form-control-solid" name="link" placeholder="contoh : https://www.instagram.com/(nama)/"></textarea>
                                        @error('link')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
