...
<!-- Mirrored from htmlbeans.com/html/schon/homepage1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Nov 2022 06:54:13 GMT -->
<head>
	...
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="{{ asset('templatesuryamart/suryamart/mart/assets/css/bootstrap.css') }}">
  <!-- include the site stylesheet -->
  <link rel="stylesheet" href="{{ asset('templatesuryamart/suryamart/mart/assets/css/animate.css') }}">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="{{ asset('templatesuryamart/suryamart/mart/assets/css/icon-fonts.css') }}">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="{{ asset('templatesuryamart/suryamart/mart/assets/css/main.css') }}">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="{{ asset('templatesuryamart/suryamart/mart/assets/css/responsive.css') }}">
</head>
<body>
	...
	<div id="wrapper">
		...
		<div id="pre-loader" class="loader-container">
			<div class="loader">
				<img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/svg/rings.svg') }}" alt="loader">
			</div>
		</div>
		<!-- W1 start here -->
		<div class="w1">
				...
				<div class="mt-bottom-bar">
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12">
								<!-- mt logo start here -->
								<div class="mt-logo"><a href="#"><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/mt-logo.png') }}" alt="schon"></a></div>
										...
										<div class="mt-drop">
											...
											<div class="mt-drop-sub">
												...
												<div class="mt-side-widget">
													<!-- cart row start here -->
													<div class="cart-row">
														<a href="#" class="img"><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/surya/img36.jpg') }}" alt="image" class="img-responsive"></a>
														<div class="mt-h">
													...
													<!-- cart row start here -->
													<div class="cart-row">
														<a href="#" class="img"><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/products/img37.jpg') }}" alt="image" class="img-responsive"></a>
														<div class="mt-h">
															<span class="mt-h-title"><a href="#">Marvelous Modern 3 Seater</a></span>
															<span class="price"><i class="fa fa-eur" aria-hidden="true"></i> 599,00</span>
														</div>
													...
													<!-- cart row start here -->
													<div class="cart-row">
														<a href="#" class="img"><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/products/img38.jpg') }}" alt="image" class="img-responsive"></a>
														<div class="mt-h">
															<span class="mt-h-title"><a href="#">Marvelous Modern 3 Seater</a></span>
															<span class="price"><i class="fa fa-eur" aria-hidden="true"></i> 599,00</span>
														</div>
										...
										<div class="mt-drop">
											...
											<div class="mt-drop-sub">
												...
												<div class="mt-side-widget">
													<!-- cart row start here -->
													<div class="cart-row">
														<a href="#" class="img"><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/products/img36.jpg') }}" alt="image" class="img-responsive"></a>
														<div class="mt-h">
															<span class="mt-h-title"><a href="#">Marvelous Modern 3 Seater</a></span>
															<span class="price"><i class="fa fa-eur" aria-hidden="true"></i> 599,00</span>
													...
													<div class="mt-f-box">
														...
														<div class="mt-col-3 promo">
															<div class="mt-promobox">
																<a href="#"><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/banner-drop.jpg') }}" alt="promo banner" class="img-responsive"></a>
															</div>
														</div>
														<!-- mt col3 end here -->
													</div>
			...
			<div class="mt-main-slider">
				...
				<div class="slider banner-slider">
					<!-- holder start here -->
					<div class="holder text-center" style="background-image: url({{ asset('templatesuryamart/suryamart/mart/assets/images/suryamart.jpeg') }});">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
					...
					<!-- holder start here -->
					<div class="holder text-center" style="background-image: url({{ asset('templatesuryamart/suryamart/mart/assets/images/sliders/img05.jpg') }});">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
					...
					<!-- holder start here -->
					<div class="holder text-center" style="background-image: url({{ asset('templatesuryamart/suryamart/mart/assets/images/sliders/img06.jpg') }});">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
									<div class="text">
                ...
                <div class="holder">
                  ...
                  <div class="col wow fadeInUp" data-wow-delay="0.4s">
                    <div class="img-holder">
                      <a href="#">
                        <img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img44.jpg') }}" alt="CLARA WOODEN">
                  ...
                  <div class="col wow fadeInUp" data-wow-delay="0.6s">
                    <div class="img-holder">
                      <a href="#">
                        <img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img45.jpg') }}" alt="JOHN WICK">
                        <ul class="list-unstyled social-icon">
                          <li><i class="fa fa-twitter"></i></li>
                          <li><i class="fa fa-facebook"></i></li>
                          <li><i class="fa fa-linkedin"></i></li>
                  ...
                  <div class="col wow fadeInUp" data-wow-delay="0.8s">
                    <div class="img-holder">
                      <a href="#">
                        <img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img46.jpg') }}" alt="HARRY KANE">
                        <ul class="list-unstyled social-icon">
                          <li><i class="fa fa-twitter"></i></li>
                          <li><i class="fa fa-facebook"></i></li>
                          <li><i class="fa fa-linkedin"></i></li>
                  ...
                  <div class="col wow fadeInUp" data-wow-delay="0.10s">
                    <div class="img-holder">
                      <a href="#">
                        <img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img47.jpg') }}" alt="CLARA WOODEN">
                      </a>
                    </div>
                  </div>
                  <!-- col of the Page end -->
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomsm">
								...
								<div class="f-widget-about">
									<div class="logo">
										<a href="#"><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/logo.png') }}" alt="Schon"></a>
									</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6 text-right">
								<div class="bank-card">
									<img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/bank-card.png') }}" alt="bank-card">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-xs-12">
							...
							<div class="slider">
								...
								<div class="product-slider">
									<div class="slide">
										<img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img03.jpg') }}" alt="image descrption">
									</div>
									<div class="slide">
										<img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img03.jpg') }}" alt="image descrption">
									</div>
								...
								<ul class="list-unstyled slick-slider pagg-slider">
									<li><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img03.jpg') }}" alt="image description"></li>
									<li><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img03.jpg') }}" alt="image description"></li>
									<li><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img03.jpg') }}" alt="image description"></li>
									<li><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img03.jpg') }}" alt="image description"></li>
									<li><img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img03.jpg') }}" alt="image description"></li>
		...
		<div id="popup2" class="lightbox">
			...
			<section class="mt-newsletter-popup">
				...
				<div class="holder">
					...
					<div class="img-holder">
						<img src="{{ asset('templatesuryamart/suryamart/mart/assets/images/img02.png') }}" alt="image description">
					</div>
	...
	<!-- include jQuery -->
	<script src="{{ asset('templatesuryamart/suryamart/mart/assets/js/jquery.js') }}"></script>
	<!-- include jQuery -->
	<script src="{{ asset('templatesuryamart/suryamart/mart/assets/js/plugins.js') }}"></script>
	<!-- include jQuery -->
	<script src="{{ asset('templatesuryamart/suryamart/mart/assets/js/jquery.main.js') }}"></script>
</body>

<!-- Mirrored from htmlbeans.com/html/schon/homepage1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Nov 2022 06:56:45 GMT -->
</html>
