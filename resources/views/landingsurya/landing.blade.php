                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 align-self-center">
                                    ...
                                    <img src="{{ asset('TempSuryamart/suryamart/mart/html/assets/surya/') }}" alt="#">
                                </div> -->
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12 align-self-center">
                                    <div class="slide-item-info">
                                        <div class="slide-item-info-inner ltn__slide-animation">
                                            ...
                                            <div class="btn-wrapper animated">
                                                <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">Lihat Katalog</a>
                                            </div>
                                        </div>
                                    </div>
        ...
        {{-- <div class="ltn__img-slider-area ltn__img-slider-2 section-bg-1 pt-115 pb-90">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area ltn__section-title-2 text-center">
                            <h1 class="section-title">Galery Suryamart</h1>
                        </div>
                    </div>
                </div>
            </div>
